            ...
            <div className="hidden lg:flex items-center gap-10">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className={`text-[13px] font-medium tracking-[0.08em] uppercase transition-colors duration-300 hover:text-romolo-red ${
                    scrolled ? "text-romolo-charcoal" : "text-white/90"
                  }`}
                >
                  {link.label}
                </a>
            ...
            >
              <span
                className={`block h-[2px] w-6 transition-all duration-300 ${
                  mobileOpen
                    ? "rotate-45 translate-y-[7px] bg-romolo-charcoal"
                    : scrolled
                    ? "bg-romolo-charcoal"
                    : "bg-white"
                }`}
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8">
          {navLinks.map((link, i) => (
            <a
              ...
              className="font-[var(--font-serif)] text-3xl font-light text-romolo-charcoal hover:text-romolo-red transition-colors"
              style={{
