          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              <input
                ...
                className="flex-1 md:w-64 px-4 py-3 bg-white/5 border border-white/15 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#2d6a4f]/60 transition-colors"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-[#2d6a4f] text-white text-[11px] font-bold tracking-[0.15em] uppercase hover:bg-[#1b4332] transition-colors shrink-0"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h4 className="font-[var(--font-serif)] text-2xl font-semibold text-[#2d6a4f] mb-3">
              Romolo&apos;s
            </h4>
              ...
              {["Heritage", "Our Process", "Menu", "Testimonials"].map((item) => (
                <li key={item}>
                  <a
                    ...
                    className="text-sm text-white/60 hover:text-[#2d6a4f] transition-colors"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              ...
              <li>
                <a href="tel:+16505740625" className="hover:text-[#2d6a4f] transition-colors">
                  (650) 574-0625
                </a>
              </li>
              <li>
                <a href="mailto:hello@romolocannoli.com" className="hover:text-[#2d6a4f] transition-colors">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center hover:border-[#2d6a4f] hover:bg-[#2d6a4f]/10 transition-all duration-300 group"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-4 h-4 text-white/50 group-hover:text-[#2d6a4f] transition-colors"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1.5}
