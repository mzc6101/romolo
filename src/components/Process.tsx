const steps = [
  {
    ...
    placeholder: "[ Image — Hands kneading cannoli dough on a marble countertop ]",
  },
  {
    number: "02",
    title: "The Shell",
    ...
    placeholder: "[ Image — Cannoli shells frying in golden oil ]",
  },
  {
    number: "03",
    title: "The Filling",
    ...
    placeholder: "[ Image — Creamy ricotta filling being prepared in a copper bowl ]",
  },
  {
    number: "04",
    title: "The Finish",
    ...
    placeholder: "[ Image — Finished cannoli being garnished with pistachios ]",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="space-y-16 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8">
          {steps.map((step, i) => (
            ...
            >
              {/* Image placeholder */}
              <div className="aspect-square bg-white/60 rounded-sm flex items-center justify-center mb-6 border border-white/80 backdrop-blur-sm">
                <div className="text-center p-6">
                  <div className="w-14 h-14 mx-auto mb-3 rounded-full bg-romolo-red/10 flex items-center justify-center">
                    <span className="font-[var(--font-serif)] text-xl font-semibold text-romolo-red">
                      {step.number}
                    </span>
                  </div>
                  <p className="text-romolo-warm-gray text-xs tracking-wide leading-relaxed">
                    {step.placeholder}
                  </p>
                </div>
              </div>
